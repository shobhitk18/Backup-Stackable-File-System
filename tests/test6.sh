#!/bin/sh
# test6 - basic view version <newest> functionality

echo "############ test6 - basic view version <newest> functionality  ###########"
...
# call bkpctl to view the newest version and then verify contents
