#!/bin/sh
# test7 - basic view version <N> functionality

echo "############ test7 - basic view version <N> functionality  ###########"
...
# call bkpctl to view the 2nd version and then verify contents
../bkpctl $file -v 2 > temp.out
retval=$?
...
# put reference output i.e version 2(N=2) in a .ref file
