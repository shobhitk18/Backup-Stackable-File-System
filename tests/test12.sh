#!/bin/sh
# test 12 : invalid version number in restore option arguments
# args : file to be operated on

echo "######### test 12 : invalid version number in restore option arguments  ###########"
...
# call bkpctl to restore version with invalid version number
../bkpctl $file -r -1
retval=$?
