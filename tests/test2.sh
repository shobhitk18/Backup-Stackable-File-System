#!/bin/sh
#test2 - basic delete <all> version functionality 

echo "############ test2 - basic delete <all> version functionality ###########"
...
if [ $retval -eq 0 ] ; then
	echo "PASSED: correct number of versions after delete"
	exit 0
else
	echo "FAILED: incorrect number of versions after delete"
	exit 1
fi
