#!/bin/sh
# test8 - basic restore version <newest> functionality

echo "############ test8 - basic restore version <newest> functionality  ###########"
...
# call bkpctl to restore the newest version and then verify contents
../bkpctl $file -r newest > temp.out
retval=$?
