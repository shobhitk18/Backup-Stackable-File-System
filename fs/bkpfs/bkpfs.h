...
/* xattr name used for storing backup file info */
#define BKPFS_XATTR_NAME "user.backup_info"
...
struct bkpfs_sb_info {
	...
	struct mnt_opt_info mnt_opts;
};

struct bkpfs_xattr_info {
	int start_ver;
	int cur_ver;
};
